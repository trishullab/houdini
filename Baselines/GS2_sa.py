...
def _train_s2t3(results_directory, save_name_cnn, save_name_mlp, save_name_rnn, save=True):
    if just_testing:
    ...
    load_from_cnn = "{}/{}.pth".format(results_directory, save_name_cnn)
    load_from_mlp = "{}/{}.pth".format(results_directory, save_name_mlp)
    load_from_rnn = "{}/{}.pth".format(results_directory, save_name_rnn)
...
if __name__ == '__main__':
    ...
    interpreter.epochs = epochs_nav
    res3 = _train_s2t3(results_dir, "s2t2_cnn", "s2t2_mlp", "s2t2_rnn")
